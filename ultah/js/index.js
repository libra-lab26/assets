...
function multifungsi(){
  ...
  function bqmuncul(){
    if(poinjwb==1){
      ...
      klganti.innerHTML="canda canda... <br> Udah lah segitu aja 🤣<br><br>";katakata = kalimat.innerHTML;kalimat.innerHTML = "";
    }
  ...
  async function aksibalas(){
    ...
    if(prtanya){
       await swals.fire({
         title: 'Tapi Boong! 🤣', 
         html: 'Gajadi ngasih kado dehh<br>takut nya nanti bikin kamu tambah perfect, dan kamu makin susah dicari 😅', 
       ...
       poinjwb=1;
	     ...
	     await swals.fire({
         title: 'Yaaahh!', 
         html: 'Yaudah kalo gamau, berarti kamu lebih milih kasih hadiah buatku, berupa smile seharian 😜', 
